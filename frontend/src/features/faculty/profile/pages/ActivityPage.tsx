...
import CreateQuestionForm from '@/app/pages/faculty/components/CreateQuestionForm';
import CreateCommunityForm from '@/app/pages/faculty/components/CreateCommunityForm';
import QuestionsList from '@/app/pages/faculty/components/QuestionsList';
import CommunitiesList from '@/app/pages/faculty/components/CommunitiesList';
